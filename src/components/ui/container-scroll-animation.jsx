...
export const Card = ({ rotate, scale, children }) => (
  <motion.div
    ...
    className="max-w-5xl -mt-12 mx-auto h-[30rem] md:h-[40rem] w-full border border-gray-200 p-2 md:p-4 bg-white rounded-[30px] shadow-[0_30px_80px_-20px_rgba(0,0,0,0.15)]"
  >
