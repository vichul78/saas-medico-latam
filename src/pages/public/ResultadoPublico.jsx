...
/**
 * ResultadoPublico — pagina publica para ver un informe compartido via token.
 *
 ...
 *
 * Diseño limpio, fondo blanco, tipografia legible para pacientes.
 */
    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center px-4">
        <div className="max-w-md w-full text-center">
          <div className="mx-auto h-16 w-16 rounded-full bg-red-50
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <span className="inline-block mt-1 px-2 py-0.5 rounded-full text-xs
                                 font-medium bg-green-100 text-green-700 capitalize">
